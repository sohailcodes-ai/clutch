...
export async function getLeaderboard(db: Database, stackId: string, limit = 50, offset = 0) {
...
export async function getUserRank(db: Database, userId: string, stackId: string) {
...
export async function refreshLeaderboardMaterialized(db: Database) {
