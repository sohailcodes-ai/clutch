...
export async function getUserRatings(db, userId) {
...
export async function getPublicProfile(db, handle) {
...
export async function listStacks(db) {
 ...
 */
export async function completeOnboarding(db, userId, input) {
