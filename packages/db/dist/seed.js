...
import { DEFAULT_RATING, PLACEMENT_MATCHES, SEASON_DECAY_AFTER_DAYS, SEASON_SOFT_RESET_FACTOR, DIFFICULTY_LADDER, STACK_CATALOG, } from '@clutch/shared';
async function main() {
    ...
    for (const t of TOPIC_CATALOG) {
        if (t.stacks === null) {
            ...
            for (const stackId of t.stacks) {
                if (!allStackRows.some((s) => s.id === stackId))
                    continue;
                await db
                    .insert(schema.topics)
    ...
    const starterQuestions = [
        ...
        },
        {
            ...
            tags: ['basics', 'strings'],
            difficultyId: 'rookie',
            promptMd: '# Greet By Name\n\nRead a name from input and print `Hello, <name>!` exactly.',
            examples: [{ input: 'Ada', output: 'Hello, Ada!', explanation: undefined }],
            testCases: [
                { visibility: 'public', input: 'Ada', expectedOutput: 'Hello, Ada!', weight: 1 },
                { visibility: 'hidden', input: 'Grace', expectedOutput: 'Hello, Grace!', weight: 1 },
                { visibility: 'hidden', input: 'Linus', expectedOutput: 'Hello, Linus!', weight: 2 },
            ],
        },
        {
            slug: 'even-or-odd',
            ...
            testCases: [
                { visibility: 'public', input: '10', expectedOutput: 'even', weight: 1 },
                { visibility: 'public', input: '7', expectedOutput: 'odd', weight: 1 },
                { visibility: 'hidden', input: '-4', expectedOutput: 'even', weight: 2 },
                { visibility: 'hidden', input: '999999999', expectedOutput: 'odd', weight: 1 },
            ],
        },
        {
            slug: 'countdown-sum',
            ...
            promptMd: '# Countdown Sum\n\nRead an integer n (0 <= n <= 1000). Print the sum of all integers from 1 to n. If n is 0, print 0.',
            examples: [{ input: '5', output: '15', explanation: '1+2+3+4+5 = 15' }],
            testCases: [
                { visibility: 'public', input: '5', expectedOutput: '15', weight: 1 },
                { visibility: 'hidden', input: '0', expectedOutput: '0', weight: 1 },
                { visibility: 'hidden', input: '100', expectedOutput: '5050', weight: 2 },
        ...
        },
        {
            ...
            testCases: [
                { visibility: 'public', input: 'clutch', expectedOutput: 'hctulc', weight: 1 },
                { visibility: 'hidden', input: 'a', expectedOutput: 'a', weight: 1 },
                { visibility: 'hidden', input: 'racecar', expectedOutput: 'racecar', weight: 2 },
            ],
        },
        {
        ...
        },
        {
            ...
            tags: ['basics', 'strings'],
            difficultyId: 'rookie',
            promptMd: '# Count The Vowels\n\nRead one line of text and print how many vowels (a, e, i, o, u) it contains. Case does not matter.',
            examples: [{ input: 'Clutch Arena', output: '4', explanation: 'u, A, a, e' }],
            testCases: [
                { visibility: 'public', input: 'Clutch Arena', expectedOutput: '4', weight: 1 },
                { visibility: 'hidden', input: 'rhythm', expectedOutput: '0', weight: 2 },
                { visibility: 'hidden', input: 'AEIOUaeiou', expectedOutput: '10', weight: 1 },
                { visibility: 'hidden', input: '', expectedOutput: '0', weight: 1 },
            ],
        },
        {
            ...
            difficultyId: 'starter',
            promptMd: '# Grade Classifier\n\nRead an integer score 0..100 and print the letter grade:\n- 90 or above: `A`\n- 80..89: `B`\n- 70..79: `C`\n- 60..69: `D`\n- below 60: `F`',
            examples: [{ input: '83', output: 'B', explanation: undefined }],
            testCases: [
                { visibility: 'public', input: '83', expectedOutput: 'B', weight: 1 },
                { visibility: 'hidden', input: '90', expectedOutput: 'A', weight: 1 },
                { visibility: 'hidden', input: '59', expectedOutput: 'F', weight: 1 },
                { visibility: 'hidden', input: '60', expectedOutput: 'D', weight: 2 },
                { visibility: 'hidden', input: '0', expectedOutput: 'F', weight: 1 },
            ],
        },
        {
        ...
        },
        {
            ...
            testCases: [
                { visibility: 'public', input: 'level', expectedOutput: 'yes', weight: 1 },
                { visibility: 'hidden', input: 'clutch', expectedOutput: 'no', weight: 1 },
                { visibility: 'hidden', input: 'x', expectedOutput: 'yes', weight: 1 },
                { visibility: 'hidden', input: 'abba', expectedOutput: 'yes', weight: 2 },
            ],
        },
        {
            ...
            tags: ['stack', 'classic'],
            difficultyId: 'hard',
            promptMd: '# Balanced Parentheses\n\nRead one line consisting only of `(`, `)`, `[`, `]`, `{`, `}`. Print `balanced` if every bracket opens and closes correctly and in the right order, else print `unbalanced`. An empty line counts as balanced.',
            examples: [{ input: '{[()]}', output: 'balanced', explanation: undefined }],
            testCases: [
                { visibility: 'public', input: '{[()]}', expectedOutput: 'balanced', weight: 1 },
                { visibility: 'hidden', input: '([)]', expectedOutput: 'unbalanced', weight: 2 },
                { visibility: 'hidden', input: '(((', expectedOutput: 'unbalanced', weight: 1 },
                { visibility: 'hidden', input: '', expectedOutput: 'balanced', weight: 2 },
                { visibility: 'hidden', input: '(){[]}()', expectedOutput: 'balanced', weight: 2 },
            ],
        },
    ];
    for (const q of starterQuestions) {
        ...
        for (const t of TOPIC_CATALOG.filter((c) => c.slug === q.topic)) {
            const candidates = topicRows.filter((row) => row.slug === t.slug && (t.stacks === null ? row.stackId === null : true));
    ...
    // ------------------------------------------------------------------
    const titleRows = [
        { code: 'on_the_board', name: 'On The Board', description: 'Complete your first ranked match.', kind: 'badge', rarity: 'common', isSecret: false, sortOrder: 1, criteria: { type: 'matches', value: 1 } },
        { code: 'first_blood', name: 'First Blood', description: 'Win a judged match without letting your opponent pass a single test.', kind: 'badge', rarity: 'uncommon', isSecret: false, sortOrder: 2, criteria: { type: 'first_blood' } },
        { code: 'problem_solver', name: 'Problem Slayer', description: 'Solve 50 unique questions.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 3, criteria: { type: 'unique_solved', value: 50 } },
        { code: 'hot_streak', name: 'Hot Streak', description: 'Win 5 ranked matches in a row.', kind: 'title', rarity: 'rare', isSecret: false, sortOrder: 4, criteria: { type: 'win_streak', value: 5 } },
        { code: 'unbroken', name: 'Unbroken', description: 'Win 10 ranked matches in a row.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 5, criteria: { type: 'win_streak', value: 10 } },
        { code: 'untouchable', name: 'Untouchable', description: 'Maintain an exceptional win streak.', kind: 'title', rarity: 'legendary', isSecret: true, sortOrder: 6, criteria: { type: 'win_streak', value: 20 } },
        { code: 'clutch_comeback', name: 'Clutch', description: 'Win a match after being significantly behind.', kind: 'title', rarity: 'rare', isSecret: true, sortOrder: 7, criteria: { type: 'comeback' } },
        { code: 'speed_demon', name: 'Speed Demon', description: 'Land a fully-accepted solve in under 60 seconds.', kind: 'badge', rarity: 'rare', isSecret: true, sortOrder: 8, criteria: { type: 'fast_win', value: 60000 } },
        { code: 'code_phantom', name: 'Code Phantom', description: '???', kind: 'title', rarity: 'legendary', isSecret: true, sortOrder: 9, criteria: { type: 'first_blood_fast', value: 60000 } },
        { code: 'polyglot', name: 'Polyglot', description: 'Win ranked matches in 3 different stacks.', kind: 'title', rarity: 'rare', isSecret: false, sortOrder: 10, criteria: { type: 'stacks_won', value: 3 } },
        { code: 'architect', name: 'Architect', description: 'Demonstrate strong performance across 5 different stacks.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 11, criteria: { type: 'stacks_won', value: 5 } },
        { code: 'adaptive', name: 'Adaptive', description: 'Solve questions across 3 difficulty levels.', kind: 'title', rarity: 'rare', isSecret: false, sortOrder: 12, criteria: { type: 'difficulty_climb', value: 3 } },
        { code: 'veteran', name: 'Veteran', description: 'Complete 100 ranked matches.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 13, criteria: { type: 'matches', value: 100 } },
        { code: 'top_100', name: 'Top 100', description: 'Reach the global top 100.', kind: 'title', rarity: 'rare', isSecret: false, sortOrder: 14, criteria: { type: 'top_rank', value: 100 } },
        { code: 'top_20', name: 'Top 20', description: 'Reach the global top 20.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 15, criteria: { type: 'top_rank', value: 20 } },
        { code: 'diamond_tier', name: 'Diamond Tier', description: 'Reach a peak rating of 2200 in any stack.', kind: 'title', rarity: 'epic', isSecret: false, sortOrder: 16, criteria: { type: 'rating', value: 2200 } },
        { code: 'clutch_master', name: 'CLUTCH', description: 'Reach a peak rating of 2400 in any stack — the highest competitive achievement.', kind: 'title', rarity: 'legendary', isSecret: false, sortOrder: 17, criteria: { type: 'rating', value: 2400 } },
    ];
    ...
    if (!activeSeason)
        throw new Error('Failed to seed active season');
    const questionSeed = {
