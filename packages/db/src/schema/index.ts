...
export const userProfiles = pgTable('user_profiles', {
  ...
  equippedTitleId: uuid('equipped_title_id').references(
    (): AnyPgColumn => titles.id,
    { onDelete: 'set null' },
  ),
...
export const userStackRatings = pgTable(
  'user_stack_ratings',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    userId: uuid('user_id')
...
export const seasonRatingSnapshots = pgTable(
...
export const questionStackSupport = pgTable(
  'question_stack_support',
  {
    questionId: uuid('question_id')
      .notNull()
      .references(() => questions.id),
...
export const matches = pgTable('matches', {
  ...
  tournamentId: uuid('tournament_id').references((): AnyPgColumn => tournaments.id, {
    onDelete: 'set null',
  }),
  createdAt: timestamp('created_at', { withTimezone: true }).notNull().defaultNow(),
})
...
export const eventStacks = pgTable(
  'event_stacks',
  {
...
export const eventDifficultyLevels = pgTable(
  'event_difficulty_levels',
  {
    eventId: uuid('event_id')
      .notNull()
      .references(() => events.id, { onDelete: 'cascade' }),
